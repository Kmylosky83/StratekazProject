    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('professional', 'Profesional Independiente'), ('consultant_company', 'Empresa Consultora'), ('direct_company', 'Empresa Directa')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('permissions', models.ManyToManyField(blank=True, to='auth_module.permission')),
            ],
        ),
    ]
